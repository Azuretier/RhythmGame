  ...
  return (
    <>
      ...
      <main className="grid grid-cols-12 grid-rows-6 grid-flow-row items-center justify-center h-screen bg-black">
          ...
          <div className="grid gap-4 p-4 rounded-xl text-base font-black text-white grid-cols-4 grid-flow-col row-start-3 col-start-6 row-span-2 col-span-3">
            ...
            <motion.a href="https://discord.gg/XkwSarHyQm" className="fade-up grid gap-3 text-indigo-400 border-2 border-black outline outline-2 outline-indigo-400 outline-offset-0 rounded-lg">
              <FaDiscord size={24} />
              <span>D</span>
            </motion.a>
