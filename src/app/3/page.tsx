  ...
  return (
    <>
      ...
      <main className="grid grid-cols-12 grid-rows-6 grid-flow-row items-center justify-center h-screen bg-black">
          ...
          <div className="grid gap-4 p-4 rounded-xl text-base font-black text-white grid-rows-6 grid-cols-6 grid-flow-col row-start-3 col-start-6 row-span-2 col-span-3 justify-around">
