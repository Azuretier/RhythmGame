...
const Gatiiku = () => {
    ...
    return (
        <main className="grid grid-flow-row gap-4 items-center justify-center h-screen">
            <section className="row-span-2"></section>    
            <motion.div 
                className="bg-white p-4 rounded-xl text-xl text-black row-start-3 row-span-2 items-start"
