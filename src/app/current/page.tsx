...
// Analytics Window
const AnalyticsWindow = memo(({ theme, isDarkMode, t }: { theme: any; isDarkMode: boolean; t: (key: string) => string }) => (
  <div className="space-y-6">
    <div className="grid grid-cols-2 gap-4">
...
const AzureDocsWindow = memo(({ theme, isDarkMode }: { theme: any; isDarkMode: boolean }) => {
